...
class NomoComponentColors {
  ...
  const NomoComponentColors({
    ...
    this.primaryButtonTheme = const PrimaryNomoButtonColorData(),
    this.secondaryButtonTheme = const SecondaryNomoButtonColorData(),
    this.textButtonTheme = const NomoTextButtonColorData(),
    this.linkButtonTheme = const NomoLinkButtonColorData(),
    this.loadingTheme = const LoadingColorData(),
    this.shimmerTheme = const ShimmerColorData(),
    this.expandableTheme = const ExpandableColorData(),
    this.inputTheme = const NomoInputColorData(),
    this.dialogTheme = const NomoDialogColorData(),
    this.cardTheme = const NomoCardColorData(),
    this.dividerTheme = const NomoDividerColorData(),
    this.infoItemTheme = const NomoInfoItemColorData(),
    this.notificationTheme = const NomoNotificationColorData(),
  });
