...
/// Controller to synchronize the fontSize of multiple NomoTexts.
class NomoTextGroup {
  final _listeners = <_NomoTextState, double>{};
  var _widgetsNotified = false;
  var _fontSize = double.infinity;

  void _register(_NomoTextState text) {
    _listeners[text] = double.infinity;
  }

  void _updateFontSize(_NomoTextState text, double maxFontSize) {
  ...
  void _remove(_NomoTextState text) {
