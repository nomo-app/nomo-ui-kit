...
class NomoText extends StatefulWidget {
  ...
  /// Creates a [NomoText] widget with a [TextSpan].
  const NomoText.rich(
  ...
  /// Synchronizes the size of multiple [NomoText]s.
  ///
  /// If you want multiple [NomoText]s to have the same text size, give all
  /// of them the same [AutoSizeGroup] instance. All of them will have the
  /// size of the smallest [NomoText]
  final NomoTextGroup? group;
  ...
  _NomoTextState createState() => _NomoTextState();
}
...
class _NomoTextState extends State<NomoText> {
  ...
  @override
  void didUpdateWidget(NomoText oldWidget) {
  ...
  Widget build(BuildContext context) {
    return LayoutBuilder(builder: (context, size) {
      ...
      if (style!.fontSize == null) {
        style = style.copyWith(fontSize: NomoText._defaultFontSize);
      }
    ...
    if (widget.data != null) {
      return Text(
        ...
        style: style.copyWith(
          fontSize: fontSize,
          color: (widget.color ?? style.color)?.withOpacity(widget.opacity!),
